...
(function () {
  ...
  /* ═════════════════════════════════════════════════════════════
     11. TOAST NOTIFICATION SYSTEM & DOWNLOAD STATUS FEEDBACK
  ═════════════════════════════════════════════════════════════ */
  ...
  var downloadBtns = document.querySelectorAll('#nav-dl-btn, #hero-dl-btn, #cta-dl-btn, .drawer-dl, a[download]');
  downloadBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      showToast(
        'Installer Update in Progress',
        'Direct downloads for Pointly (Pointly-Setup.exe) are temporarily paused while our automated build pipeline updates. This issue is actively being resolved and downloads will be restored shortly! In the meantime, please explore our interactive live demo below.',
        '🛠️'
      );
    });
  });
