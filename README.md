...
Pointly is a lightweight, screen-aware desktop companion built in JavaScript (Node.js & Electron) powered by Google Gemini and Sarvam AI. Pointly lives as a tiny 26px Dark Red buddy beside your mouse cursor, providing hands-free push-to-talk voice guidance, Chrome & webpage navigation, guided application workflows (e.g. drafting mail in Microsoft Word and pointing out UI buttons step-by-step), Windows OS window controls, desktop file navigation, transient spoken affirmations, and silent text commands without popping open any large windows.
...
1. **Chrome & Webpage Navigation**:
   - **Open Websites & Search**: Say *"Open YouTube / GitHub in Chrome"* or *"Search for AI news on Chrome"*. Pointly launches the browser, loads the site, and glides to the address bar and content canvas.
   - **Browser UI Pointing**: Pointly visually highlights key Chrome buttons (Address Bar/Omnibox, New Tab +, Refresh, Back/Forward).
   - **Webpage Scrolling & Controls**: Say *"Scroll down on the webpage"*, *"Scroll up"*, or *"Reload page"* ➔ Pointly navigates through page content for you.

2. **Guided Application Workflow & UI Button Pointing**:
   - Say or type *"Draft me a mail body in Word"*:
     - **Drafts the email** using Gemini AI and automatically copies it to your clipboard.
     - **Launches Microsoft Word**.
     - **Step 1**: Glides its glowing beacon ring to the **New Blank Document** button and speaks *"Step 1: Click Blank Document here."*
     - **Step 2**: Glides to the **Document Canvas**, displays the draft in the caption bubble, and speaks *"Step 2: Press Ctrl+V to paste your drafted email."*
     - **Step 3**: Points to the top ribbon for **File > Share/Export**.
     - Includes interactive **`Next Step ➔`** and **`📋 Copy Draft`** controls.

3. **Ultra-Compact 26px Dark Red Buddy (`#800a1e`)**:
...
4. **Windows OS Window & Application Control**:
...
5. **Desktop File & Screen Awareness**:
...
6. **Multi-Model Gemini & Sarvam Voice Engine**:
