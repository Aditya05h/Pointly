...
├── README.md                         # Comprehensive desktop app documentation
│
...
## 🌐 Companion Web Portal (`Pointly-Web`)
 
The Pointly project includes a dedicated standalone showcase web portal located in the [`Pointly-Web/`](../Pointly-Web/) directory featuring:
